...
const columns = [
    ...
    {
        title: "Name", dataIndex: "name, img", key: "key", render: (_, record) => (
            <div className='item'>
    ...
    {
        title: "Quantity", dataIndex: "qty", key: "key", render: (_, record) => (
            <>
                Qty {record.qty}
            </>
        )
    ...
    {
        title: "Amount", dataIndex: "amount", key: "key", render: (_, record) => (
            <>
                £{record.amount}
            </>
        )
                ...
                expandedRowRender: record => (
                    <div className='nested__table-wrapp'>
                        ...
                        <table className='nested__table'>
                            {
                                record.booked?.map(book => (
                                    <tr>
                                        <td>{book?.id}</td>
                                        <td><Image src={book?.avatar} alt=' ' /></td>
                                        <td>{book?.text}</td>
                                        <td><Link href="#"><a>Veiw Details</a></Link></td>
                                    </tr>
                                ))
                            }
                        </table>
